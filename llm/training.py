...
if __name__ == "__main__":
    ...
    parser.add_argument("--hf-repo", type=str, default=config.hf_repo,
                        help="The name of the HuggingFace repo to push the model to.")
    ...
    parser.add_argument('--output-dir', type=str,
                        default=config.hf_repo, help="The output directory.")
